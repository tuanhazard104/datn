...
from .cnn_backbone.resnet50.model import ResNetV2
...
class Embeddings(nn.Module):
    ...
    def __init__(self, config, img_size, in_channels=3):
        ...
        patch_size = _pair(config.patches.grid)
        n_patches = 196 # output of resnet50 is 1024,14,14 so n_patches = 14*14

        self.hybrid_model = ResNetV2(block_units=config.resnet.num_layers, width_factor=config.resnet.width_factor)
        in_channels = 1024 #  output channel of resnet50
