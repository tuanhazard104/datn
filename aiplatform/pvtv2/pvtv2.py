...
class PyramidVisionTransformerV2(nn.Module):
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dims=[64, 128, 256, 512],
        ...
        for i in range(num_stages):
            ...
            patch_embed1 = in_chans if i == 0 else embed_dims[i - 1]
            patch_embed2 = img_size if i == 0 else img_size // (2 ** (i + 1))
            patch_embed3 = 7 if i == 0 else 3
            patch_embed4 = embed_dims[i]
            patch_embed5 = 4 if i == 0 else 2
            print(f"inchans={patch_embed1}, img_size={patch_embed2}, patch_size={patch_embed3}, stride={patch_embed5} embad_dim={patch_embed4}")
